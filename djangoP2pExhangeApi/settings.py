"""
Django settings for djangoP2pExhangeApi project.
...
ROOT_URLCONF = 'djangoP2pExhangeApi.urls'
...
WSGI_APPLICATION = 'djangoP2pExhangeApi.wsgi.application'
...
ACCESS_TOKEN_LIFETIME_IN_MIN = os.getenv('ACCESS_TOKEN_LIFETIME_IN_MIN', 5)
REFRESH_TOKEN_LIFETIME_IN_DAYS = os.getenv('REFRESH_TOKEN_LIFETIME_IN_DAYS', 1)
